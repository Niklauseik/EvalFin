...
# **Fine-tuned `GPT-4o-mini`（QA 任务）**
fine_tuned_model = "ft:gpt-4o-mini-2024-07-18:personal:answer-first:B44PSLIx"  # ✅ `GPT-4o-mini` 训练的模型（请替换为你的微调 ID）
...
results_dir = "results/finqa/answer_first"

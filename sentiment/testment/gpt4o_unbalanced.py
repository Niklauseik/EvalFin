...
# **Fine-tuned `GPT-4o`（unbalanced 数据集）**
fine_tuned_model = "ft:gpt-4o-2024-08-06:personal:unbalanced:B3kCc1jd"  # ✅ 修改为 `GPT-4o` 训练的模型

# 读取测试数据集
test_file = "datasets/sentiment.csv"
df = pd.read_csv(test_file)

# 确保 `unbalanced_4o` 结果存储目录存在
results_dir = "datasets/results/sentiment/unbalanced_4o"

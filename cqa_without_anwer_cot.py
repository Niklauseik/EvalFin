...
for dataset_name, file_path in datasets.items():
    ...
    for i, row in df.iterrows():
        ...
        cot_prompt = (
            ...
            "1. Identify the relevant financial figures from the provided data.\n"
            "2. Determine the formula or calculation method needed to derive the answer.\n"
    ...
    # **保存预测结果 CSV**
    results_file = os.path.join(results_dir, f"{dataset_name}_cot.csv")  # ✅ 另存为 CoT 版本
